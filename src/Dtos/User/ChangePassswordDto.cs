...
namespace TallerIDWM.Src.DTOs.User
{
    public class ChangePasswordDto
    {
        ...
        [StringLength(100, MinimumLenght = 8, ErrorMessage = "La contraseña actual debe tener al menos 8 caracteres.")]
        [RegularExpression(
        ...
        [StringLength(100, MinimumLenght = 8, ErrorMessage = "La nueva contraseña debe tener al menos 8 caracteres.")]
        [RegularExpression(
            @"^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$",
